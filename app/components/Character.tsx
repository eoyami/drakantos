...
const Character = ({id, name, src, alt, type, OpenModal}: CharacterProps) => {
  ...
  return (
    <>
          <div key={id} className="flex flex-col justify-center items-center h-40 w-40 bg-black/30 rounded p-2 hover:bg-white/30 transition ease-in-out hover:cursor-pointer" onClick={() => {OpenModal()}}>
